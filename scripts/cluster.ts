#!/usr/bin/env tsx
/**
 * Clustering pipeline for the UK Plinko casino affiliate project (Agent 2).
 *
 * Pipeline:
 *   1. Read data/keywords-raw.csv (Agent 1 output).
 *   2. For every keyword eligible for clustering, fetch/derive a top-10 SERP
 *      signature for google.co.uk (gl=gb, hl=en), cached at
 ...
 *     engine=google, google_domain=google.co.uk, gl=gb, hl=en, num=10).
